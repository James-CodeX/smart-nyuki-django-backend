    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beekeeper', models.ForeignKey(help_text='The beekeeper who owns this device', on_delete=django.db.models.deletion.CASCADE, related_name='devices', to='accounts.beekeeperprofile')),
